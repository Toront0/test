...
const Header = () => {
  return (
    <div className="flex bg-[#fafafa] items-center justify-between px-4 py-2">
      ...
      <div className="flex">
        <button className="w-8 h-8 rounded-full flex items-center justify-center hover:bg-opac-b-1 dark:bg-opac-w-1">
